...
* [`modern-data-platform`](https://github.com/TrivadisPF/platys-modern-data-platform/modern-data-platform-stack) - a Platform Stack for supporting a Modern (Analytical) Data Platforms
